...
Calling /help shows how to use the bot.

To use, a telegram_config.yaml file needs to include the [Bot token](https://core.telegram.org/bots) and the group and/or chat id to which the Bot should respond. 